                    ...
                    <div class="collapse navbar-collapse main-menu-item justify-content-end"
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="blog.jsp" id="navbarDropdown" role="button"
...
<section class="sample-text-area">
    <div class="container box_1170">
        ...
        <p class="sample-text">
            ...
            do you move from a
            <del>Strike</del>
            through of master DVDs with the <u>“Underline”</u> marked hand-written title
            ...
            <div class="progress-table-wrap">
                <div class="progress-table">
                    ...
                    <div class="table-row">
                        ...
                        <div class="country"><img src="${pageContext.request.contextPath}img/elements/f1.jpg"
                                                  alt="flag">Canada
                        </div>
                    ...
                    <div class="table-row">
                        ...
                        <div class="country"><img src="${pageContext.request.contextPath}img/elements/f2.jpg"
                                                  alt="flag">Canada
                        </div>
                        <div class="visit">645032</div>
                        <div class="percentage">
                    ...
                    <div class="table-row">
                        ...
                        <div class="country"><img src="${pageContext.request.contextPath}img/elements/f3.jpg"
                                                  alt="flag">Canada
                        </div>
                        <div class="visit">645032</div>
                        <div class="percentage">
                    ...
                    <div class="table-row">
                        ...
                        <div class="country"><img src="${pageContext.request.contextPath}img/elements/f4.jpg"
                                                  alt="flag">Canada
                        </div>
                        <div class="visit">645032</div>
                        <div class="percentage">
                    ...
                    <div class="table-row">
                        ...
                        <div class="country"><img src="${pageContext.request.contextPath}img/elements/f5.jpg"
                                                  alt="flag">Canada
                        </div>
                        <div class="visit">645032</div>
                        <div class="percentage">
                    ...
                    <div class="table-row">
                        ...
                        <div class="country"><img src="${pageContext.request.contextPath}img/elements/f6.jpg"
                                                  alt="flag">Canada
                        </div>
                        <div class="visit">645032</div>
                        <div class="percentage">
                    ...
                    <div class="table-row">
                        ...
                        <div class="country"><img src="${pageContext.request.contextPath}img/elements/f7.jpg"
                                                  alt="flag">Canada
                        </div>
                        <div class="visit">645032</div>
                        <div class="percentage">
                    ...
                    <div class="table-row">
                        ...
                        <div class="country"><img src="${pageContext.request.contextPath}img/elements/f8.jpg"
                                                  alt="flag">Canada
                        </div>
                        <div class="visit">645032</div>
                        <div class="percentage">
