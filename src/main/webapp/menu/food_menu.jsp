            ...
            <div class="col-lg-6">
                <div class="nav nav-tabs food_menu_nav" id="myTab" role="tablist">
                    <a class="active" id="Main-tab" data-toggle="tab" href="#Main" role="tab"
                       aria-controls="Main" aria-selected="false">메인 메뉴<img
                            src="${pageContext.request.contextPath}/img/icon/play.svg" alt="play"></a>
                    <a id="Side-tab" data-toggle="tab" href="#Side" role="tab" aria-controls="Side"
                       aria-selected="false">사이드 메뉴<img src="${pageContext.request.contextPath}/img/icon/play.svg"
                                                        alt="play"></a>
                    <a id="Drink-tab" data-toggle="tab" href="#Drink" role="tab" aria-controls="Drink"
                       aria-selected="false">음료<img src="${pageContext.request.contextPath}/img/icon/play.svg"
                                                    alt="play"></a>
