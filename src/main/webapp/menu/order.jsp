                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <div class="menu_btn" id="orderCheckbtn">
                                <a href="#" class="btn_1 d-none d-sm-block">주문내역</a>
                            </div>
                        </c:otherwise>
                    </c:choose>
                </nav>
        ...
        <div class="row justify-content-between">
            ...
            <div class="col-lg-12">
                <div class="tab-content" id="myTabContent">
                    <h3>
                        <label style="display: block; text-align: center;"> <strong>메인
                            메뉴</strong>
                        </label>
                    </h3>
                    <br />
                            ...
                            <div class="col-sm-6 col-lg-6">
                                <div class="single_food_item media">
                                    ...
                                    <div class="media-body align-self-center">
                                        ...
                                        <div class="size-control">
                                            <label class="genric-btn danger circle"> <input
                                                    type=radio name="main_menu1" data-size="l"
                                                    onclick="updatePrice('main_menu1', 'l')"> L (￦<span
                                                    id=main_menu1_price_l>22,500</span>)
                                            </label> <label class="genric-btn danger circle"> <input
                                                type=radio name="main_menu1" data-size="xl"
                                                onclick="updatePrice('main_menu1', 'xl')"> XL (￦<span
                                                id=main_menu1_price_xl>25,500</span>)
                                        </label>
                                        </div>
                                        <h5>
                                            ￦<span id="main_menu1_price">0</span>
                                        </h5>
                                        <div class="product">
                                ...
                                <div class="single_food_item media">
                                    ...
                                    <div class="media-body align-self-center">
                                        ...
                                        <div class="size-control">
                                            <label class="genric-btn danger circle"> <input
                                                    type="radio" name="main_menu2" data-size="l"
                                                    onclick="updatePrice('main_menu2', 'l')"> L (￦<span
                                                    id=main_menu2_price_l>29,500</span>)
                                            </label> <label class="genric-btn danger circle"> <input
                                                type="radio" name="main_menu2" data-size="xl"
                                                onclick="updatePrice('main_menu2', 'xl')"> XL (￦<span
                                                id=main_menu2_price_xl>32,500</span>)
                                        </label>
                                        </div>
                                        <h5>
                                            ￦<span id="main_menu2_price">0</span>
                                        </h5>
                                        <div class="product">
                                            <div class="quantity-control">
                                                <button class="quantity-button"
                                ...
                                <div class="single_food_item media">
                                    ...
                                    <div class="media-body align-self-center">
                                        ...
                                        <div class="size-control">
                                            <label class="genric-btn danger circle"> <input
                                                    type="radio" name="main_menu3" data-size="l"
                                                    onclick="updatePrice('main_menu3', 'l')"> L (￦<span
                                                    id=main_menu3_price_l>30,000</span>)
                                            </label> <label class="genric-btn danger circle"> <input
                                                type="radio" name="main_menu3" data-size="xl"
                                                onclick="updatePrice('main_menu3', 'xl')"> XL (￦<span
                                                id=main_menu3_price_xl>33,000</span>)
                                        </label>
                                        </div>
                                        <h5>
                                            ￦<span id="main_menu3_price">0</span>
                                        </h5>
                                        <div class="product">
                                            <div class="quantity-control">
                                                <button class="quantity-button"
                            ...
                            <div class="col-sm-6 col-lg-6">
                                <div class="single_food_item media">
                                    ...
                                    <div class="media-body align-self-center">
                                        ...
                                        <div class="size-control">
                                            <label class="genric-btn danger circle"> <input
                                                    type="radio" name="main_menu4" data-size="l"
                                                    onclick="updatePrice('main_menu4', 'l')"> L (￦<span
                                                    id=main_menu4_price_l>18,500</span>)
                                            </label> <label class="genric-btn danger circle"> <input
                                                type="radio" name="main_menu4" data-size="xl"
                                                onclick="updatePrice('main_menu4', 'xl')"> XL (￦<span
                                                id=main_menu4_price_xl>21,500</span>)
                                        </label>
                                        </div>
                                        <h5>
                                            ￦<span id="main_menu4_price">0</span>
                                        </h5>
                                        <div class="product">
                                            <div class="quantity-control">
                                                <button class="quantity-button"
                                ...
                                <div class="single_food_item media">
                                    ...
                                    <div class="media-body align-self-center">
                                        ...
                                        <div class="size-control">
                                            <label class="genric-btn danger circle"> <input
                                                    type="radio" name="main_menu5" data-size="l"
                                                    onclick="updatePrice('main_menu5', 'l')"> L (￦<span
                                                    id=main_menu5_price_l>20,500</span>)
                                            </label> <label class="genric-btn danger circle"> <input
                                                type="radio" name="main_menu5" data-size="xl"
                                                onclick="updatePrice('main_menu5', 'xl')"> XL (￦<span
                                                id=main_menu5_price_xl>23,500</span>)
                                        </label>
                                        </div>
                                        <h5>
                                            ￦<span id="main_menu5_price">0</span>
                                        </h5>
                                        <div class="product">
                                            <div class="quantity-control">
                                                <button class="quantity-button"
                                ...
                                <div class="single_food_item media">
                                    ...
                                    <div class="media-body align-self-center">
                                        ...
                                        <div class="size-control">
                                            <label class="genric-btn danger circle"> <input
                                                    type="radio" name="main_menu6" data-size="l"
                                                    onclick="updatePrice('main_menu6', 'l')"> L (￦<span
                                                    id=main_menu6_price_l>28,000</span>)
                                            </label> <label class="genric-btn danger circle"> <input
                                                type="radio" name="main_menu6" data-size="xl"
                                                onclick="updatePrice('main_menu6', 'xl')"> XL (￦<span
                                                id=main_menu6_price_xl>31,000</span>)
                                        </label>
                                        </div>
                                        <h5>
                                            ￦<span id="main_menu6_price">0</span>
                                        </h5>
                                        <div class="product">
                                            <div class="quantity-control">
                                                <button class="quantity-button"
                    ...
                    <hr />
                    <h3>
                        <label style="display: block; text-align: center;"> <strong>사이드
                            메뉴</strong>
                        </label>
                    </h3>
                    <br />
                        ...
                        <div class="col-sm-6 col-lg-6">
                            <div class="single_food_item media">
                                ...
                                <div class="media-body align-self-center">
                                    ...
                                    <h5>
                                        ￦<span id="side_menu1_price">6,900</span>
                                    </h5>
                                    <div class="product">
                                        <div class="quantity-control">
                                            <button class="quantity-button"
                            ...
                            <div class="single_food_item media">
                                ...
                                <div class="media-body align-self-center">
                                    ...
                                    <p>웨스턴 스타일로 매콤하게</p>
                                    <h5>
                                        ￦<span id="side_menu2_price">9,800</span>
                                    </h5>
                                    <div class="product">
                                        <div class="quantity-control">
                                            <button class="quantity-button"
                            ...
                            <div class="single_food_item media">
                                ...
                                <div class="media-body align-self-center">
                                    ...
                                    <h5>
                                        ￦<span id="side_menu3_price">9,800</span>
                                    </h5>
                                    <div class="product">
                                        <div class="quantity-control">
                                            <button class="quantity-button"
                        ...
                        <div class="col-sm-6 col-lg-6">
                            <div class="single_food_item media">
                                ...
                                <div class="media-body align-self-center">
                                    ...
                                    <h5>
                                        ￦<span id="side_menu4_price">9,800</span>
                                    </h5>
                                    <div class="product">
                                        <div class="quantity-control">
                                            <button class="quantity-button"
                            ...
                            <div class="single_food_item media">
                                ...
                                <div class="media-body align-self-center">
                                    ...
                                    <h5>
                                        ￦<span id="side_menu5_price">2,400</span>
                                    </h5>
                                    <div class="product">
                                        <div class="quantity-control">
                                            <button class="quantity-button"
                ...
                <hr />
                <h3>
                    <label style="display: block; text-align: center;"> <strong>음료</strong>
                    </label>
                </h3>
                <br />
                <div class="row">
                    <div class="col-sm-6 col-lg-6">
                        <div class="single_food_item media">
                            ...
                            <div class="media-body align-self-center">
                                ...
                                <h5>
                                    ￦<span id="drink_menu1_price">2,300</span>
                                </h5>
                                <div class="product">
                                    <div class="quantity-control">
                                        <button class="quantity-button"
                        ...
                        <div class="single_food_item media">
                            ...
                            <div class="media-body align-self-center">
                                ...
                                <h5>
                                    ￦<span id="drink_menu2_price">2,300</span>
                                </h5>
                                <div class="product">
                                    <div class="quantity-control">
                                        <button class="quantity-button"
                        ...
                        <div class="single_food_item media">
                            ...
                            <div class="media-body align-self-center">
                                ...
                                <h5>
                                    ￦<span id="drink_menu3_price">2,400</span>
                                </h5>
                                <div class="product">
                                    <div class="quantity-control">
                                        <button class="quantity-button"
                    ...
                    <div class="col-sm-6 col-lg-6">
                        <div class="single_food_item media">
                            ...
                            <div class="media-body align-self-center">
                                ...
                                <h5>
                                    ￦<span id="drink_menu4_price">1,700</span>
                                </h5>
                                <div class="product">
                                    <div class="quantity-control">
                                        <button class="quantity-button"
                        ...
                        <div class="single_food_item media">
                            ...
                            <div class="media-body align-self-center">
                                ...
                                <h5>
                                    ￦<span id="drink_menu5_price">1,700</span>
                                </h5>
                                <div class="product">
                                    <div class="quantity-control">
                                        <button class="quantity-button"
                        ...
                        <div class="single_food_item media">
                            ...
                            <div class="media-body align-self-center">
                                ...
                                <h5>
                                    ￦<span id="drink_menu6_price">1,700</span>
                                </h5>
                                <div class="product">
                                    <div class="quantity-control">
                                        <button class="quantity-button"
...
<div style="text-align: center;" class="gray_bg">
    <button class="button button-contactForm" id="popup_open_btn"
            onclick="openModal('my_modal')">주문</button>
...
<div id="my_modal" style="display: none;">
    <div class="container">
        ...
        <form id="orderForm">
            ...
            <div class="menu-item">
                <h3>메인 메뉴</h3>
                <label for="main_menu_quantity">수량:</label>
                <input type="number" id="main_menu_quantity" name="main_menu_quantity" min="0">
            </div>

            <!-- 사이드 메뉴 주문 폼 -->
            <div class="menu-item">
                <h3>사이드 메뉴</h3>
                <label for="side_menu_quantity">수량:</label>
                <input type="number" id="side_menu_quantity" name="side_menu_quantity" min="0">
            </div>

            <!-- 음료 메뉴 주문 폼 -->
            <div class="menu-item">
                <h3>음료</h3>
                <label for="drink_menu_quantity">수량:</label>
                <input type="number" id="drink_menu_quantity" name="drink_menu_quantity" min="0">
            </div>
    ...
    <div class="modal-buttons">
        <button class="modal_order_btn" onclick="sendOrder()">주문하기</button>
        <button class="modal_close_btn" onclick="closeModal()">닫기</button>
    </div>
</div>
